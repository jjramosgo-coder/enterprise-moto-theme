...
| 47 | mejora | **[#41 · Fase III.2] UX del editor: personalización por región.** El autor asigna por región **color** (tokens §13.18) y **descripción** (alimenta el globo); UX de asignación masiva con el modal paginado de `routes-by-location` **como referencia**. Frontera (¿solo presentación o también revisar/override asociaciones?) a fijar en su doc de requisitos. Requiere doc de requisitos. Ver §13.19. **Tema a analizar:** el orden de resolución de color cuando ambos coexistan (región #47 > paleta global #54 > horneado del activo). | pendiente |
