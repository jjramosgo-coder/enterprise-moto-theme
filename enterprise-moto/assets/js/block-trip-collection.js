...
(function () {
  ...
  var blockIcon = el('svg', { viewBox:'0 0 24 24', xmlns:'http://www.w3.org/2000/svg' },
    el('path', { d:'M4 5h6v6H4V5zm10 0h6v6h-6V5zM4 15h6v4H4v-4zm10 0h6v4h-6v-4z', stroke:'currentColor', strokeWidth:1.5, strokeLinejoin:'round', fill:'none' })
  );

  /* ── CheckList reutilizable (idéntico patrón a post-stages) ── */
  ...
  wp.blocks.registerBlockType('enterprise/trip-collection', {
    title:       'Colección de viajes',
    description: 'Muestra viajes/rutas (entradas completas) filtrados por categorías, etiquetas y fechas, como tarjetas de viaje. Para páginas curadas de colección.',
    category:    'enterprise-moto',
    icon:        blockIcon,
    keywords:    ['colección','viajes','rutas','tarjetas','vacaciones','puente','categoría','etiqueta'],
    ...
    edit: function(props) {
      ...
      return el(Fragment, null,
        ...
        el('div', bp,
          el(SSR, {
            block:'enterprise/trip-collection', attributes:attr,
