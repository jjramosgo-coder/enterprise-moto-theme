 ...
 *   C1 (este): bootstrap + modelo de visibilidad (ent-active/ent-dimmed/ent-hidden).
 *   C2: hover con globo bilingüe.
...
(function () {
  ...
  /* <button> con un SVG inline (flecha de retorno curva), sin texto visible,
     arriba-izquierda. En C1 queda oculto por CSS (solo visible con .is-drilled,
  ...
  function bindEvents(state) {
    /* Clic delegado. En C1 solo se resuelve el path; el drill (zoom + revelar
